...
-- @@IDENTITY is a variable that holds the last-generated IDENTITY value for a table with an IDENTITY column (PK)
    ...
    BEGIN -- {
        ...
        BEGIN -- {
            ...
            BEGIN -- { -- This BEGIN/END is needed, because of two SQL statements
                ...
                VALUES (@Description)
				IF @@ERROR <> 0 -- An ERROR values other than zero means there is a problem
				BEGIN -- {
