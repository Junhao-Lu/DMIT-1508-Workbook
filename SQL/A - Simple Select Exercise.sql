...
-- 5.b  Given that the Instructor position id is 4, write a query to get the names of all the instructors from the Staff table.
SELECT FirstName, LastName
FROM	Staff
WHERE	PositionID = 4
...
SELECT  CourseID, CourseName as programming
FROM    Course
...
SELECT  StudentID
FROM    Payment
WHERE   Amount < 500 OR PaymentTypeID LIKE '5'